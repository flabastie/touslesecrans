...
/*
  ...
  * controleurs/insert_produit.php
*/
...
// inclusion du modèle
include(dirname(__FILE__).'/../modeles/insert_produit.php');
...
// inclusion de la vue
include(dirname(__FILE__).'/../vues/insert_produit.php');
?>
